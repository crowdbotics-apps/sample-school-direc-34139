...
## Project Structure
    ...
    ├── sample_school_direc_34139  # Django project configurations
...
1. Clone this repo and `cd sample_school_direc_34139`
...
2. Clone this repo and `cd sample_school_direc_34139`
